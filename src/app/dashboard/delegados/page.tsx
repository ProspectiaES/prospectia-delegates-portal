    ...
    <div className="max-w-screen-xl mx-auto px-6 py-8 space-y-6">
      ...
      <div className="flex items-end justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          {isOwner && (
            <Link
              href="/dashboard/delegados/riesgo"
              className="h-9 px-4 flex items-center gap-2 rounded-lg border border-[#E5E7EB] text-sm font-medium text-[#374151] hover:bg-[#F9FAFB] transition-colors"
            >
