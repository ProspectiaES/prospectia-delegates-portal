  ...
  return (
    <div className="min-h-screen bg-[#F5F5F7]">
      <header className="bg-white border-b border-[#E5E7EB]">
        <div className="max-w-screen-lg mx-auto px-6 h-14 flex items-center gap-6">
          <Link href="/cliente" className="flex items-center gap-2.5 shrink-0">
            <img src="/Logo-OWL_1.ico" alt="Prospectia" className="w-7 h-7 rounded-md object-contain" />
            <span className="text-sm font-bold text-[#0A0A0A] hidden sm:inline">Prospectia</span>
          </Link>
          <ClienteNav />
          <div className="flex items-center gap-4 ml-auto">
            <span className="text-xs text-[#6B7280] hidden sm:inline">Hola, {contact.name}</span>
